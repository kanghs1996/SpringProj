...
<div class="container">
	...
	<fieldset>
		...
		<ul>
			...
			<li><a href="<c:url value="/Database/JNDIConnection.do?method=JNDI"/>">JDBC CP사용</a></li>
			<li><a href="<c:url value="/Database/HikariConnection.do?method=HIKARI"/>">Hikari CP사용</a></li>
		</ul>	
	</fieldset>
